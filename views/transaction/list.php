              ...
              <!-- 
				...
				<p>
                  ...
                  <!-- start menu -->
                   ...
                   <?php
                    $no2 = 1;
					$query = mysqli_query($mysqli, "select * from menus where menu_type_id = '".$row_cat['menu_type_id']."' order by menu_id");
                 ...
                 <div class="row">   
                    ...
                    <div class="row">   
                      ...
                      <div class="col-xs-4" style="padding-left: 0">
                       <div class="form-group">
                          <input class="btn btn-warning button_checkout" type="submit" value="OK"/>
                        </div>
                      </div>
                    </div>
