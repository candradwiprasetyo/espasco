...
<?php
while($row_item2 = mysqli_fetch_array($query_item2)){
?>
...
?>
	...
	function get_total(){
		var total = 0;
		<?php
		while($row_item3 = mysqli_fetch_array($query_item3)){
		?>
...
<section class="content">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                                        ...
                                        <?php
                                        $query_member = mysqli_query($mysqli, "select a.*
																	from members a																
																	order by member_id
																	");
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <?php
                                        $query_menu = mysqli_query($mysqli, "select * from menus order by menu_id
																	");
